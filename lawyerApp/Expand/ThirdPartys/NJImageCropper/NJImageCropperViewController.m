...
- (void)initView {
    ...
    if (self.tag == 100) {
           self.ratioView.frame =CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height);
    }else{
           self.ratioView.frame =CGRectMake(0, 0, self.view.frame.size.width * 0.85, self.view.frame.size.width * 0.85);
    }
    self.ratioView.center = self.showImgView.center;
...
//    CGRect squareFrame = (CGRectMake(0, 0, self.view.frame.size.width * 0.75, self.view.frame.size.width * 0.75));
    ...
    if(self.tag == 100){
        myImageRect = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
    }
