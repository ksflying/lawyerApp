...
typedef void(^SelectSectionView)();
...
@property (nonatomic,strong) ASButton *menuButton;
...
// HQ
@property (nonatomic,strong) NSString * sectionTitle1;
@property (nonatomic,strong) NSString * sectionTitle2;
@property (nonatomic,copy) SelectSectionView selectSectionView;
